...
public class ThemeOverlayController extends CoreStartable implements Dumpable {
    ...
    public void start() {
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.EXTENDED_MONET_THEMES),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SMALL_CLOCK_DOUBLE_LINE),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
        ...
        mSecureSettings.registerContentObserverForUser(
                Settings.Secure.getUriFor(Settings.Secure.KG_CUSTOM_CLOCK_FONT),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
        ...
        mSecureSettings.registerContentObserverForUser(
                Settings.Secure.getUriFor(Settings.Secure.KG_CUSTOM_DATE_FONT),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.LAUNCHER_SHOW_WEATHER_TEMP),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
    ...
    private void updateThemeOverlays() {
        ...
        int isExtendedTheme = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.EXTENDED_MONET_THEMES , 0, currentUser);
