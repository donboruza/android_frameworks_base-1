...
public final class PowerManagerService extends SystemService
    ...
    private void systemReady() {
        ...
        resolver.registerContentObserver(LineageSettings.System.getUriFor(
                ...
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(Settings.Secure.getUriFor(
                Settings.Secure.SCARLET_AGGRESSIVE_IDLE_MODE),
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(Settings.Secure.getUriFor(
                Settings.Secure.SCARLET_AGGRESSIVE_IDLE_MODE_WAKELOCK_BLOCKER),
                false, mSettingsObserver, UserHandle.USER_ALL);
    ...
    private void updateSettingsLocked() {
        ...
        mScarletAggEnabled = Settings.Secure.getInt(resolver,
                Settings.Secure.SCARLET_AGGRESSIVE_IDLE_MODE, 0);
        mScarletWLBlocker = Settings.Secure.getInt(resolver,
                Settings.Secure.SCARLET_AGGRESSIVE_IDLE_MODE_WAKELOCK_BLOCKER, 0);
    ...
    private void acquireWakeLockInternal(IBinder lock, int displayId, int flags, String tag,
        ...
        synchronized (mLock) {
            ...
            if (tag.toLowerCase().contains("wakerlock")){
            ...
            if (mScarletAggEnabled == 1 && mScarletWLBlocker == 1) {
               blockWakelock = true;
            }
